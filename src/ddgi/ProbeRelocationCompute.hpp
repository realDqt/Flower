...
class ProbeRelocationCompute : public DDGICompute{
public:
    ProbeRelocationCompute(
            VkDevice _device,
    ...
    void prepare() override{
        ...
        computePipelineCreateInfo.stage = loadShader(getShadersPath() + "ddgi/ProbeRelocation.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
